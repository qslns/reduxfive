...
export const designers: Designer[] = [
  {
    ...
    bio: 'REDUX의 크리에이티브 디렉터로서 색채와 텍스처를 통해 감정을 표현한다. 패션 필름이라는 매체를 통해 의상의 움직임과 감정을 영상 언어로 번역하며, 시각적 스토리텔링의 새로운 가능성을 탐구하고 있다.',
  ...
  },
  {
    ...
    bio: '시각 예술과 패션의 경계를 넘나드는 멀티미디어 아티스트. 디지털 매체를 통해 패션의 경계를 확장하고, 온라인 공간에서의 새로운 패션 경험을 디자인한다. 가상과 현실을 잇는 혁신적인 작업을 이어가고 있다.',
  ...
  },
  {
    ...
    mainRole: 'Fashion Designer',
    role: 'Web Designer',
    bio: 'REDUX의 웹디자이너로서 실험적인 패션과 예술의 경계를 탐구한다. 미니멀리즘과 구조적 실루엣을 바탕으로 독창적인 작품 세계를 구축하며, 패션과 디지털 매체를 통해 새로운 이야기를 만들어가고 있다.',
  ...
  },
  {
    ...
    bio: '전통과 현대를 융합한 독특한 미학을 추구하는 패션 디자이너. 지속가능한 패션에 대한 깊은 관심을 바탕으로 환경을 생각하는 창작 활동을 이어가며, 한국적 정서와 현대적 감각을 조화롭게 표현하고 있다.',
  ...
  },
  {
    ...
    bio: '기능성과 예술성을 결합한 혁신적인 패션을 선보이는 디자이너. 프로젝트 매니저로서 REDUX의 다양한 프로젝트를 기획하고 관리하며, 팀의 창의적 비전을 현실로 구현하는 역할을 담당하고 있다.',
