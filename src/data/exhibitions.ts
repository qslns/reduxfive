...
export const exhibitions: Exhibition[] = [
  {
    ...
    title: 'CINE MODE',
    titleKo: '시네 모드',
    description: 'Fashion in motion. Five visions converge through contemporary lens. Moving images meet spatial narrative.',
  ...
  },
  {
    ...
    title: 'THE ROOM OF [ ]',
    titleKo: '더 룸 오브 [ ]',
    description: 'Void as potential. Space as canvas. Where absence creates infinite presence in fashion form.',
